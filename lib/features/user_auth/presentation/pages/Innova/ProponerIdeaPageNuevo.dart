...
import 'package:pucpflow/features/user_auth/presentation/pages/Innova/AnalisisIdeaPage.dart';
// Your app imports
...
class ProponerIdeaPageEstiloInnova extends StatefulWidget {
  const ProponerIdeaPageEstiloInnova({super.key});

  @override
  State<ProponerIdeaPageEstiloInnova> createState() => _ProponerIdeaPageEstiloInnovaState();
}

class _ProponerIdeaPageEstiloInnovaState extends State<ProponerIdeaPageEstiloInnova> {
...
void _irAAnalisisIdeaPage(String ideaId) {
  Navigator.push(
    context,
    PageRouteBuilder(
      transitionDuration: const Duration(milliseconds: 700),
      pageBuilder: (_, animation, secondaryAnimation) => AnalisisIdeaPage(ideaId: ideaId),
...
Future<void> _mostrarGIFDeCarga() async {
  await showDialog(
    context: context,
    ...
    builder: (_) => Center(
      child: Container(
        ...
        child: Image.asset('assets/animation.gif'), // ✅ Asegúrate de tener el gif en assets
      ),
    ),
  );
}
  ...
  Future<void> _enviarIdea() async {
    ...
    final idea = Idea(
      ...
      causas: _causasController.text.trim(), // <-- asegúrate que sea String
      herramientas: _herramientasController.text.trim(),
      solucion: _solucionController.text,
      ataque: _ataqueController.text,
      materiales: _materialesController.text,
      titulo: "", // Inicialmente vacío, será generado por IA
    );
    ...
    try {
      ...
      final tituloIA = result.data['titulo'] ?? '';
      ...
      _irAAnalisisIdeaPage(_ideaRef!.id);
      print("✅ Análisis IA exitoso, título generado: $tituloIA");
    ...
    pw.MultiPage(
      ...
      build: (context) => [
        ...
        _seccion("1. Fase de Contexto", subtitulo, textoNormal, [
          ...
          "Causas: ${_causasController.text is String ? _causasController.text : (_causasController.text.toString())}",
  ...
  children: [
    ...
    Align(
      ...
      child: FractionallySizedBox(
        heightFactor: 0.55, // 👉 Desde mitad inferior
        child: Container(
          decoration: BoxDecoration(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildFaseCompleta(
                  ...
                  onEliminarImagen: _imagenURL1 != null ? () => setState(() => _imagenURL1 = null) : null,
                ...
                _buildFaseCompleta(
                  ...
                  onEliminarImagen: _imagenURL2 != null ? () => setState(() => _imagenURL2 = null) : null,
                ...
                FilledButton.icon(
                  ...
                  style: FilledButton.styleFrom(
                    backgroundColor: const Color(0xFF5B4115),
                  ),
                ),
                ...
                if (_respuestaIA != null && _respuestaIteracion == null)
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF5B4115)),
