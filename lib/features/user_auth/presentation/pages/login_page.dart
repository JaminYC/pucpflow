...
class _LoginPageState extends State<LoginPage> {
  ...
  void _signIn() async {
    ...
    if (user != null) {
      ...
      _navigateBasedOnUserProfile(user.uid);
    } else {
      showToast(message: "An error occurred during login");
    }
  }

  Future<void> _navigateBasedOnUserProfile(String userId) async {
    final profileExists = await _userProfileService.checkIfUserProfileExists(userId);
    ...
    try {
      ...
      if (googleSignInAccount != null) {
        ...
        if (userCredential.user != null) {
          _navigateBasedOnUserProfile(userCredential.user!.uid);
        }
      }
    } catch (e) {
      showToast(message: "An error occurred during Google sign-in: $e");
    }
  }
